...
export const TRIGGER_MODE_TEXT = {
  [TriggerMode.Always]: { title: 'Always', desc: 'ChatGPTonBard is queried on every search' },
  [TriggerMode.Manually]: {
    title: 'Manually',
    desc: 'ChatGPTonBard is queried when you manually click a button',
  },
}
...
export const Prompt =
  'Please give some insights on the following:\
 '
